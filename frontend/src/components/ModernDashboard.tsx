...
import DocumentDraftingPage from './DocumentDraftingPage';
...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { id: 'cases', label: 'Case Analysis', icon: Scale, color: '#f59e0b' },
  ...
  const renderActiveView = () => {
    switch (activeTab) {
        ...
        return (
          <Box sx={{ textAlign: 'center', py: 8 }}>
            ...
            <Typography color="text.secondary">
              Advanced legal search capabilities coming soon...
            </Typography>
          </Box>
        );
      case 'research':
        return (
          <Box sx={{ textAlign: 'center', py: 8 }}>
            ...
            <Typography color="text.secondary">
              Comprehensive research tools coming soon...
            </Typography>
          </Box>
        );
      case 'analytics':
        return (
          <Box sx={{ textAlign: 'center', py: 8 }}>
            <TrendingUp size={64} color="#64748b" />
            <Typography variant="h4" sx={{ mt: 2, mb: 1, fontWeight: 600 }}>
              Analytics Dashboard
            </Typography>
            <Typography color="text.secondary">
      ...
      case 'practice':
        return (
          <Box sx={{ textAlign: 'center', py: 8 }}>
            <Briefcase size={64} color="#64748b" />
            <Typography variant="h4" sx={{ mt: 2, mb: 1, fontWeight: 600 }}>
              Practice Areas
            </Typography>
            <Typography color="text.secondary">
              Practice area management coming soon...
            </Typography>
          </Box>
        );
      default:
